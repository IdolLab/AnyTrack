        ...
        while not valid:
            ...
            try:
                ...
                data = TensorDict({'template_images': template_frames,
                                   ...
                                   'text_description': template_anno['text_description'],
                                   'audio_description': template_anno['audio_description'],
                                   'search_images': search_frames,
                                   'search_anno': search_anno['bbox'],
                                   'search_prev_anno': search_anno.get('prev_bbox', search_anno['bbox']), # 搜索区域前一帧的bbox

...
from lib.models.anytrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def finetune_track_vit(self, cfg, patch_start_index=1):
    ...
    def forward(self, z, x, track_query=None, tau=0.5, **kwargs):
        """
        ...
        Returns:
            ...
            attn : None
        """
        x, aux_dict ,len_zx = self.forward_features(z, x, track_query=track_query, tau=tau)
